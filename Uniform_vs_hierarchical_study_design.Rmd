...
Code for trying to create the within-plot variance for each of the 10 plots with a variance-covariance matrix
...
Sigma <- lqmm::make.positive.definite(Sigma, tol=1e-3)
E=MASS::mvrnorm(mu = c(rep(0,100)), Sigma = Sigma) 
