...
## Code for tmodel with within-plot variance for each of the 10 plots with a variance-covariance matrix
...
transient = 500*thin # what length of a transient
...
- The two lines of the plot (black and red) describe the MCMC chains
  - They yield identical results - convergence of the Chains, nice!
  - they rapidly rise and fall - no autocorrelation, nice!
  - seem to have reached a stationary distribution as first half of recorded iterations looks similar to second half in the plot, nice!


- The effective sample size shows how much the consecutive samples are autocorrelated 
- The potential scale reduction factor shows how consistent the results between both chains are 
...
...Include  what R2 does
+ why it shoud be evaluated more by cross validation/ why it does not describe the predicitve power of the model
