...
p= c(0.3, 0.5, 0.1, 0.2, 0.7, 0.2, 0.4, 0.5, 0.2, 0.9) # proportion of residual variance that can be attributed to the plot level (of the 10 plots)
...
Sigma <- lqmm::make.positive.definite(Sigma, tol=1e-3)
E=MASS::mvrnorm(n=1, mu = c(rep(0,100)), Sigma = Sigma) 
